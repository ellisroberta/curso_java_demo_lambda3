...
public class Program {
    ...
    public static void main(String[] args) {
        ...
        // Atualiza o preço de cada produto chamando o método não estático nonStaticPriceUpdate
        list.forEach(Product::nonStaticPriceUpdate); // Utiliza referência de método para atualizar o preço
